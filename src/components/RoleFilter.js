...
const RoleFilter = () => {
    ...
    const renderStepComponent = () => {
        switch (step) {
            ...
            case 3:
                return selectedActor? <ActorDetails actor={selectedActor} data={data} />: null
            case 4:
                return selectedActor? <ActorCastList data={data} actor={selectedActor} />: null
            case 5:
                return selectedActor? <ActorWorkedWith data={data} actor={selectedActor} />: null
            case 6:
                return selectedActor? <ActorTitle data={data} actor={selectedActor} />: null
            case 7:
                return selectedActor? <ActorPresenceChart data={data} actor={selectedActor} />: null
            case 8:
                return selectedActor? <ActorShowsCSVExport data={data} actor={selectedActor} />: null
            default:
                return null;
        }
    };
